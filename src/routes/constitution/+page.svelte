...
>>>>>>> 35eb99b (Updates the Constitution page)
...
>>>>>>> 35eb99b (Updates the Constitution page)
    ...
    <p>Trading of players and draft picks (up to 2 drafts away) is allowed. Trades will process immediately and will be reversed if under investigation for collusion. <ul>Trades will not be reversed if one party is a dipshit.</ul> Tradable assets include players, draft picks, and FAAB $.</p>
    ...
    <div class="subBlock">
        <p>Player lending is prohibited and determined by the commissioner, lending falls under an act of collusion.</p>
    </div>
    ...
    <div class="subBlock">
        <p>You will not be able to trade draft picks that are more than 2 drafts away. For example, during the 2024 season you cannot trade any picks in or after the 2027 draft. You may only trade FAAB $ from the current and next season.</p>
    </div>    
    
    <h3 bind:this={oneThree}>1.3 Waiver Wire</h3>
    
    <p>FAAB Waiver wire system. Each team will begin the season with $200. $0 bids are allowed. Bids will process Wednesday 3AM EST.</p>
    ...
    <p>When a manager needs to be replaced, the commisiooners will try to find a suitable candidate with some connection to at least a portion of the existing managers. Priority will be placed on managers who are eager to be very active within the league.</p>
    
    <h2 class="sectionHeading" bind:this={seven}>Section 7 League Finances</h2>
    
    <h3 bind:this={sevenOne}>7.1 League Dues</h3>
    <p>League dues are set at {dues}$. Dues are collected through the commissioner and collection will be sent out no later than the first of August. All managers must be fully paid up before the start of regular season. In the event that a manager fails to pay before the deadline, a 10% penalty will be addd to their payment and will go towards the payouts at the end of the year.</p>
