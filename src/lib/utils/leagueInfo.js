/*   STEP 1   */
export const leagueID = "1048281947404955648"; // your league ID
export const leagueName = "Show Us Your TD's"; // your league name
...
export const homepageText = `
  <p>Welcome to the website for the fantasy league Show Us Your TD's.</p>
`;
...
export const managers = [
     {
       ...
       "philosophy": "Try not to get injured and score more points than the other team.",
    ...
    },
    {
      ...
      "name": "Jared",
      "location": "TUL", // (optional)
      "bio": "I’m always looking to trade so send them my way!  No one on my team is untouchable, but if you want an elite player, it will take an elite offer. I'm open to negotiate on most any trade that I send or receive, especially if it involves future picks or FAAB money! ",
      ...
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "You can’t win the league on draft night but you sure can lose it! ",
      "tradingScale": 10, // 1 - 10
      "preferredContact": "Text", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
    }, 
    {
    ...
    },
    {
      ...
      "location": "DAL", // (optional)
      "bio": "Lorem ipsum...",
      "photo": "/managers/travis_holly.png", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2019, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "dal", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
