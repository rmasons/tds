...
<svelte:head>
	<title>{!$page.url.pathname[1] ? 'Home' : $page.url.pathname[1].toUpperCase() + $page.url.pathname.slice(2)} | Show Us Your TD's</title>
</svelte:head>
...
<nav>
	<a href="/"><img id="logo" alt="league logo" src="/tds.png" /></a>
